...
// =============================================================
// New in Phase 7 — inline field editor
// =============================================================

/** Pencil edit glyph. Hover-revealed in the FieldActions group
 * (Phase 7 PR B). Click triggers the inline editor's
 * idle → editing transition. SVG path verbatim from the mockup
 * sprite at `Resources/onboarding-tab-mockup.html` line 342
 * (`<symbol id="i-edit">`). */
